...
[1 Getting started with Pyramid
[4](#getting-started-with-pyramid)](#getting-started-with-pyramid)

[1.1 Keyboard shortcuts [4](#keyboard-shortcuts)](#keyboard-shortcuts)

[1.1.1 Intern at Pyramid [4](#intern-at-pyramid)](#intern-at-pyramid)

[1.1.1 External to Pyramid
[5](#external-to-pyramid)](#external-to-pyramid)

[1.1 Description of the interfaces
[5](#description-of-the-interfaces)](#description-of-the-interfaces)

[1.1.1 Parameterization toolbar
[6](#parameterization-toolbar)](#parameterization-toolbar)

[1.1.1.1 Button hide the navigation window
[6](#button-hide-the-navigation-window)](#button-hide-the-navigation-window)

[1.1.1.1 Save button [6](#save-button)](#save-button)

[1.1.1.1 Project configuration button
[7](#project-configuration-button)](#project-configuration-button)

[1.1.1.1 User parameter button
[8](#user-parameter-button)](#user-parameter-button)

[1.1.1.1 Refresh button [9](#refresh-button)](#refresh-button)

[1.1.1 Undo/Redo buttons [9](#undoredo-buttons)](#undoredo-buttons)

[1.1.1 Workspace Toolbar [10](#workspace-toolbar)](#workspace-toolbar)

[1.1.1.1 Test button [10](#test-button)](#test-button)

[1.1.1.1 Workspace properties button
[10](#workspace-properties-button)](#workspace-properties-button)

[1.1.1.1 Button hide the properties window
[13](#button-hide-the-properties-window)](#button-hide-the-properties-window)

[1.1.1 Navigation window [13](#navigation-window)](#navigation-window)

[1.1.1.1 Add a new root button
[13](#add-a-new-root-button)](#add-a-new-root-button)

[1.1.1.1.1 Column of categories
[14](#column-of-categories)](#column-of-categories)

[1.1.1.1.1 Column for viewing the category content
[15](#column-for-viewing-the-category-content)](#column-for-viewing-the-category-content)

[1.1.1.1.1 Preview column [15](#preview-column)](#preview-column)

[1.1.1.1 Checkable button hide/show threads
[16](#checkable-button-hideshow-threads)](#checkable-button-hideshow-threads)

[1.1.1.1 List of threads in the workspace
[18](#list-of-threads-in-the-workspace)](#list-of-threads-in-the-workspace)

[1.1.1 Context menu right click
[18](#context-menu-right-click)](#context-menu-right-click)

[1.1.1.1 Search for the selected item
[19](#search-for-the-selected-item)](#search-for-the-selected-item)

[1.1.1.1 Inspection of the selected element
[20](#inspection-of-the-selected-element)](#inspection-of-the-selected-element)

[1.1.1.1 Adding a child and removing an element
[21](#adding-a-child-and-removing-an-element)](#adding-a-child-and-removing-an-element)

[1.1.1.1 Modify the index of a child in its parent
[22](#modify-the-index-of-a-child-in-its-parent)](#modify-the-index-of-a-child-in-its-parent)

[1.1.1.1 Group the selection of elements
[23](#group-the-selection-of-elements)](#group-the-selection-of-elements)

[1.1.1.1 Level on the layer
[23](#level-on-the-layer)](#level-on-the-layer)

[1.1.1.1 Copy/Paste [24](#copypaste)](#copypaste)

[1.1.1 Properties window [24](#properties-window)](#properties-window)

[1.1.1.1 Properties tab (Props)
[25](#properties-tab-props)](#properties-tab-props)

[1.1.1.1 Visual tab (Visuals)
[26](#visual-tab-visuals)](#visual-tab-visuals)

[1.1.1.1 Layout tab [27](#layout-tab)](#layout-tab)

[1.1.1.1.1 Basic layout [28](#basic-layout)](#basic-layout)

[1.1.1.1.1 Linear layout [28](#linear-layout)](#linear-layout)

[1.1.1.1.1 Flow arrangement [29](#flow-arrangement)](#flow-arrangement)

[1.1.1.1.1 Frame layout [30](#frame-layout)](#frame-layout)

[1.1.1.1 Geometry tab (Geo) [31](#geometry-tab-geo)](#geometry-tab-geo)

[1.1.1.1 Theme management tab (Toplo-Theme)
[31](#theme-management-tab-toplo-theme)](#theme-management-tab-toplo-theme)

[1.1.1.1.1 Adding a theme for toplo theme manager
[33](#adding-a-theme-for-toplo-theme-manager)](#adding-a-theme-for-toplo-theme-manager)

[1.1.1.1 Playground tab [34](#playground-tab)](#playground-tab)

[1.1.1 Workspace [37](#workspace)](#workspace)

[1.1 Features [38](#features)](#features)

[1.1.1 Clicked arborescence modification dragged / dropped
[38](#clicked-arborescence-modification-dragged-dropped)](#clicked-arborescence-modification-dragged-dropped)

[1.1.1 Dynamic resizing of selected element
...
> \- Do not inherit the theme from the parent and choose the theme to
> apply on himself and these children
>
> \- Add a label (stamp) on the selected element (greyed out if no
> element has been selected).
>
> \- Delete a selected label from the listed label table (grayed out if
...
> height disappears.
>
> \- When the height of the element is below 50, the square to change
> the size for width disappears.
>
